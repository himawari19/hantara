...
export function LoginScreen() {
  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center bg-[var(--bg-primary)]">
      <div className="flex w-full max-w-sm flex-col items-center gap-6 rounded-lg border border-[var(--border)] bg-[var(--bg-secondary)] p-8">
        {/* Logo */}
        <div className="flex flex-col items-center gap-2">
          <h1 className="text-3xl font-bold text-[var(--accent)]">Hantara</h1>
          <p className="text-sm text-[var(--text-secondary)]">
            Fast, collaborative API client
          </p>
        </div>
